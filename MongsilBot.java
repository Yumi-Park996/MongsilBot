...
public class MongsilBot {
    public static void main(String[] args) {
        ...
        String[] questions = {
            "뀨우뀨우 안녕! 몽실아, 오늘도 힘들게 하루를 보낸 집사님을 위해 200자 이내의 따뜻한 위로 메시지를 전해줄래?",
            "뀨우뀨우 안녕! 몽실아, 누군가 오늘 힘든 하루를 보냈대. 위로가 될 수 있는 200자 이내의 다정한 메시지를 전해볼래?",
            "뀨우뀨우 안녕! 몽실아, 집사님이 지쳤대. 네가 줄 수 있는 200자 이내의 가장 따뜻한 격려와 응원의 말을 해줄 수 있을까?",
            "뀨우뀨우 안녕! 몽실아, 오늘 하루도 열심히 살아낸 집사님에게 너의 사랑스러운 말로 힘이 되는 200자 이내의 메시지를 전해줘!",
            "뀨우뀨우 안녕! 몽실아, 때로는 힘든 날도 있는 법이지? 지금 힘들어하는 사람들에게 너만의 방식으로 용기를 200자 이내의 메시지로 줄 수 있을까?",
            "뀨우뀨우 안녕! 몽실아, 세상은 가끔 힘들지만, 너의 귀여운 응원이 있다면 괜찮아질 것 같아. 위로와 용기의 메시지를 200자 이내로 보내줄래?"
        };
